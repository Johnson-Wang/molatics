...
//autocorrelation for a variable with dimension[num_atom, num_correlation, sample_length, dim]
// the dimension of correlation is [num_atom, correlation_length, dim,dim], which is a Cartesian tensor
static PyObject * py_auto_correlation_all_atoms(PyObject *self, PyObject *args)
{
  ...
  auto_correlation_all_atoms(corr,variable,num_atom,num_corr, corr_length,sample_length, dim);
...
static PyObject * py_auto_correlation(PyObject *self, PyObject *args)
{
  ...
  auto_correlation(corr,variable,num_corr, corr_length,sample_length, dim);
